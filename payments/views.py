...
class GatewayView(APIView):
    def get(self, request):
        ...
        serializer = GatewaySerializers(gateways, many=True)
...
class PaymentView(APIView):
    ...
    def get(self, request):
        ...
        return Response({'token': payment.token, 'callback_url': 'https://yoursite.com/pay/pay/'})
    ...
    def post(self, request):
        ...
        return Response({'detail': 'Payment verification Successful.'})